...
# This script converts the shared PACE documentation into the Markdown format
...
echo "========================="
echo "Running this script will update PACE's documentation. Before running, confirm that "
...
DOC_SHARED="PACE Model Documentation.docx"  # the file name of the shared version
